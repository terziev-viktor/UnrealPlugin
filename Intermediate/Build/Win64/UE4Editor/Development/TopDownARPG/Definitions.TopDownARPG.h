#undef TOPDOWNARPG_API
#undef TOPDOWNARPG_VTABLE
...
#define UE_PROJECT_NAME TopDownARPG
...
#define TOPDOWNARPG_VTABLE DLLEXPORT_VTABLE
#define TOPDOWNARPG_API DLLEXPORT
